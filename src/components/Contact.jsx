  ...
  return (
    <section id='contact' className='section'>
        <div className="container lg:grid lg:grid-cols-2 lg:gap-5 lg:-mt-10 items-center">
            ...
            <form action="" method='POST' className='xl:pl-10 2xl:p-20'>
                <div  className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                    <div className='mb-4'>
                        <label htmlFor="name" className='label'>Name</label>
                        <input type="text" name='name' id='name' autoComplete='name' required placeholder='Juan Dela Cruz' className="text-field" />
                    </div>
                    <div className='mb-4'>
                        <label htmlFor="email" className='label'>Email</label>
                        <input type="email" name='email' id='email' required placeholder='sample@email.com' className="text-field" />
                    </div>
                </div>
                <div className='mb-4'>

...
const ProjectDetails = () => {
  ...
  return (
    <section className='section min-h-screen flex lg:items-center lg:justify-center relative'>
      ...
      <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] -z-9"></div>
      <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_-20%,#1D293D_40%,#03050b_100%)]"></div>

      <div className="container lg:grid lg:grid-cols-2 lg:gap-5 lg:!px-4 lg:!max-w-[90%] items-center pb-30">
        ...
        <div className='mb-12 lg:mb-0 lg:flex lg:flex-col lg:mr-10'>
          ...
          <motion.p 
            className='text-gray-400 mb-6 max-w-[85ch] whitespace-pre-wrap'
            initial={{ opacity: 0, x: -100 }}
            whileInView={{ opacity: 1, x: 0 }}
